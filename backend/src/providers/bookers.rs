...
const META: &[Meta] = &[
    Meta { id: "google-flights", name: "Google Flights", layer: "meta-search", role: "Metasearch: compares and hands off. Does not issue the e-ticket.", issues: false, tmpl: "" },
    Meta { id: "kayak", name: "Kayak", layer: "meta-search", role: "Metasearch. Booking completes on an airline or OTA, not on this link alone.", issues: false, tmpl: "https://www.kayak.com/flights/{o}-{d}/{kayak_dates}{kayak_adults}?sort=bestflight_a" },
    Meta { id: "skyscanner", name: "Skyscanner", layer: "meta-search", role: "Metasearch. Date path is YYMMDD. Not the validating carrier.", issues: false, tmpl: "https://www.skyscanner.com/transport/flights/{ol}/{dl}/{sky_path}?adultsv2={adults}&cabinclass={sky_cabin}&rtn={sky_rtn}&preferdirects=false" },
    Meta { id: "momondo", name: "Momondo", layer: "meta-search", role: "Kayak-family metasearch. Often wider international OTA coverage.", issues: false, tmpl: "https://www.momondo.com/flight-search/{o}-{d}/{kayak_dates}{kayak_adults}?sort=bestflight_a" },
    Meta { id: "cheapflights", name: "Cheapflights", layer: "meta-search", role: "Kayak-family metasearch. US-facing comparison.", issues: false, tmpl: "https://www.cheapflights.com/flight-search/{o}-{d}/{kayak_dates}{kayak_adults}?sort=bestflight_a" },
    Meta { id: "wego", name: "Wego", layer: "meta-search", role: "Metasearch strong in the Middle East and Asia.", issues: false, tmpl: "https://www.wego.com/flights/searches/{o}-{d}-{wego_dates}/economy/{adults}a" },
    Meta { id: "expedia", name: "Expedia", layer: "ota", role: "OTA. Typically issues via GDS as merchant of record if you finish checkout there.", issues: true, tmpl: "https://www.expedia.com/Flights-Search?flight-type=on&mode=search&trip=oneway&leg1=from:{o},to:{d},departure:{us}TANYT&passengers=adults:{adults},children:0,infantinlap:N" },
    Meta { id: "booking-com", name: "Booking.com", layer: "ota", role: "OTA. Flight checkout on Booking.com can issue the ticket if you finish there.", issues: true, tmpl: "https://flights.booking.com/flights/{ob}-{db}/?type={book_type}&adults={adults}&cabinClass={book_cabin}&depart={date}{book_return}&from={o}&to={d}&sort=BEST" },
    Meta { id: "trip-com", name: "Trip.com", layer: "ota", role: "OTA. Trip.com is often merchant of record if you finish checkout there.", issues: true, tmpl: "https://www.trip.com/flights/{ol}-to-{dl}/?dcity={o}&acity={d}&ddate={date}{trip_adate}&flighttype={flighttype}&class=ys&quantity={adults}" },
    Meta { id: "priceline", name: "Priceline", layer: "ota", role: "OTA. Booking Holdings shop. Can issue if you finish checkout there.", issues: true, tmpl: "https://www.priceline.com/m/fly/search/{priceline_path}/?cabin-class=ECO&no-of-adults={adults}" },
    Meta { id: "kiwi", name: "Kiwi.com", layer: "ota", role: "OTA. Virtual interlining / self-transfer specialist. Issues if you finish there.", issues: true, tmpl: "https://www.kiwi.com/en/search/results/{ol}/{dl}/{date}/{kiwi_ret}?adults={adults}" },
    Meta { id: "cheapoair", name: "CheapOair", layer: "ota", role: "US OTA. Can issue if you finish checkout there.", issues: true, tmpl: "https://www.cheapoair.com/flights/results?from={o}&to={d}&fromDt={us}{cheapo_ret}&tripType={cheapo_trip}&adults={adults}" },
    Meta { id: "edreams", name: "eDreams", layer: "ota", role: "European OTA. Can issue if you finish checkout there.", issues: true, tmpl: "https://www.edreams.com/flights/{edreams_path}" },
    Meta { id: "traveloka", name: "Traveloka", layer: "ota", role: "Southeast Asia OTA. Can issue if you finish checkout there.", issues: true, tmpl: "https://www.traveloka.com/en-en/flight/fullsearch?ap={o}.{d}&dt={tvldt_pair}&ps={adults}.0.0" },
    Meta { id: "makemytrip", name: "MakeMyTrip", layer: "ota", role: "India OTA. Can issue if you finish checkout there.", issues: true, tmpl: "https://www.makemytrip.com/flight/search?itinerary={mmt_itin}&tripType={mmt_trip}&paxType=A-{adults}_C-0_I-0&cabinClass=E" },
    Meta { id: "despegar", name: "Despegar", layer: "ota", role: "Latin America OTA. Can issue if you finish checkout there.", issues: true, tmpl: "https://www.despegar.com/shop/flights/results/{despegar_kind}/{o}/{d}/{date}{despegar_ret}/{adults}/0/0" },
    Meta { id: "skiplagged-com", name: "Skiplagged.com", layer: "specialist-meta", role: "Specialist hidden-city search. Independent of this repo.", issues: false, tmpl: "https://skiplagged.com/flights/{o}/{d}/{date}" },
];
