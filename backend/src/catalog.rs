...
pub static SOURCES: LazyLock<Vec<SourceDef>> = LazyLock::new(|| {
    vec![
        ...
        src(
            ...
            "Momondo",
            "meta-search",
            "Kayak-family metasearch. Deep-link only. Featured on some European pairs.",
            "Not the ticket issuer.",
        ...
        src(
            ...
            "Cheapflights",
            "meta-search",
            "Kayak-family metasearch. Deep-link only. Featured on North American pairs.",
            "Not the ticket issuer.",
        ...
        src(
            ...
            "Wego",
            "meta-search",
            "Metasearch for Middle East and Asia. Deep-link only. Featured when the pair touches that market.",
            "Not the ticket issuer.",
        ...
        src(
            ...
            "eDreams",
            "ota",
            "European OTA. Deep-link only. Featured when the pair touches Europe.",
            "Not a fare we price in this API.",
        ...
        src(
            ...
            "Traveloka",
            "ota",
            "Southeast Asia OTA. Deep-link only. Featured when the pair touches that market.",
            "Not a fare we price in this API.",
        ...
        src(
            ...
            "MakeMyTrip",
            "ota",
            "India OTA. Deep-link only. Featured when the pair touches India.",
            "Not a fare we price in this API.",
        ...
        src(
            ...
            "Despegar",
            "ota",
            "Latin America OTA. Deep-link only. Featured when the pair touches that market.",
            "Not a fare we price in this API.",
